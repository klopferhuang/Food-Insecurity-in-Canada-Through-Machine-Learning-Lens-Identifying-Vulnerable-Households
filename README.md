...

{
 "cells": [
  {
   "cell_type": "markdown",
   "id": "e0ac84cb-13e1-4ecc-868b-5d7e3e1cd4e3",
   "metadata": {
    "editable": true,
    "slideshow": {
     "slide_type": ""
  ...
  {
   "cell_type": "markdown",
   "id": "36b72c1a-7832-4e9e-911b-98a02d327fe6",
   "metadata": {
   ...
   "source": [
    "### **Models** \n",
    "\n",
    "#### **Baseline Model (Non-Machine Learning):** \n",
    "\n",
  ...
  {
   "cell_type": "markdown",
   "id": "a3b4fc54-575e-4f35-ba78-b1f4878477b9",
   "metadata": {},
   "source": [
    "## **Result** \n",
    "\n",
  ...
  {
   "cell_type": "markdown",
   "id": "f2753c5c-53e7-437a-845b-d183ac30a433",
   "metadata": {},
   "source": [
    "### **Identifying Key Predictors for Presence of Food Insecurity** \n",
    "\n",
    "#### **Gini importance** \n",
    ...
    "![Distribution of dwltyp](./images/Gini.png)\n",
    "\n",
    "\n",
    ...
    "![Distribution of dwltyp](./images/SHAPv.png)\n",
    "\n",
    "\n",
    "\n",
    "### **Robustness Test** \n",
  ...
  {
   "cell_type": "markdown",
   "id": "adada3d5-a2b9-4950-ba17-18cbd3847e2a",
   "metadata": {},
   "source": [
    "## Conclusion \n",
  ...
  {
   "cell_type": "markdown",
   "id": "36aaed50-2158-4efc-a4b0-ebc78e97b96f",
   "metadata": {},
   "source": [
    "## References \n",
    "\n",
  ...
  {
   "cell_type": "markdown",
   "id": "5bbae943-ca6e-4a1c-8446-cc12c18a3527",
   "metadata": {
    "tags": []
   },
   "source": [
    ...
    "\n",
    "![Distribution of dwltyp](./images/un.png)\n",
    "\n",
    "\n",
    "## Additional Tables \n",
    "\n",
